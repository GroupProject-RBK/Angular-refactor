...
@Component({
  selector: 'app-ngb-carousel-basic',
  templateUrl: './ngb-carousel-basic.component.html',
  styleUrls: ['./ngb-carousel-basic.component.css']
})
export class NgbCarouselBasicComponent {
